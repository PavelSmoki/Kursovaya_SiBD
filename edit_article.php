                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px; margin-top: 20px; margin-bottom: 20px;">
                            <div class="card-body p-5">
                                <h2 class="text-uppercase text-center mb-5">Редактирование статьи</h2>

                                <form method="post">
                                    <?php include('error.php'); ?>
                                    <div class="form-outline mb-4">
                                        <label class="form-label">Название Статьи</label>
                                        <input type="text" class="form-control form-control-lg" name="title" placeholder="Можно оставить пустым" />
                                    </div>
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <select class="form-control form-control-lg"
                                            style="text-align: center; width: 250px;" name="category">
                                    ...
                                    <textarea class="form-control form-control-lg" name="text" placeholder="Можно оставить пустым" 
                                        style="width: 100%; height: 200px; margin-bottom: 20px;"></textarea>
                                    <div class="d-flex justify-content-center">
                                        <button type="submit"
                                            class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"
                                            name="edit_article">Отредактировать</button>
                                    </div>
